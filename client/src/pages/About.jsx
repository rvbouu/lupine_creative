      ...
      <div className= "about-container">
        ...
        <h1 className="title">If you really wanna know the whooooollle story of how this came to be....here's the deets</h1>
          ...
          <p>I started by wanting to make some for myself and for gifts. I shared a few photos on social media and, completely unexpectedly, got a bunch of comments and messages of people who wanted to BUY them! Whaaaaat?! So I started selling a few here and there and made a few custom pieces too. </p>
            <br></br>
          <p>After I realized how much I loved making them and that they could be a fun side hustle, I started to look for other opportunities. Somehow, those opportunities found me. So humbled. </p>
            <br></br>
          <p>Boise is such a special community in this way and the entire summer I sold my earrings I was constantly surprised, grateful, and in awe of peoples' outreach and kindness. I hardly had to look for places to sell them and instead got asked to do First Thursdays and a friend helped connect me with someone to get me down at our local Saturday Market. Holy smokes! All of a sudden I'm selling at a couple events every week, doing a Wine Drinking and Clay Crafting event every month, I did a bachelorette party where the girls could make stuff...IT WAS SO FUN!!!</p>
            <br></br>
          <p>At the end of that summer my wanderlust self got the best of me. I had made some extra money with Jypsea Lady Jewelry on top of my serving job, had gone through a break up, and wanted to leave the country. Sooooo I did. I spent a year between the Philippines, Malaysia, Singapore, and New Zealand. </p>
            <br></br>
          <p>All of it came to a screeching halt when Covid came around and I made my way back to Idaho. Not wanting to go back into the restaurant industry, I decided to start a different company doing residential interior painting. What can I say, I'll do anything to create some art.</p>
            <br></br>
          <p>I got asked a lot if I would return to doing my earrings but there was something that always stood in my way, and as lame as it may sound, I hated the name of the company. I felt like it restricted me to just jewelry when I wanted to make other things too. I also felt like a little girl named it and the "Jypsea" part didn't really feel right being in a landlocked state and all. I spent the last couple years randomly writing down names that I could call the new company and since I love Lupines and they are an Idaho wildflower, I decided to go with Lupine Creative.</p>
            <br></br>
